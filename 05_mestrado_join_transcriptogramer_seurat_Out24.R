...
MCF10A_notreated_batch1 <- subset(MCF10A_notreated_batch1, subset = nFeature_RNA > 200 & nFeature_RNA < 8500 & percent.mt < 5)
MCF10A_notreated_batch2 <- subset(MCF10A_notreated_batch2, subset = nFeature_RNA > 200 & nFeature_RNA < 8500 & percent.mt < 5)
MCF10A_TGFbeta1_1day_batch2 <- subset(MCF10A_TGFbeta1_1day_batch2, subset = nFeature_RNA > 200 & nFeature_RNA < 8500 & percent.mt < 5)
MCF10A_TGFbeta1_2day_batch2 <- subset(MCF10A_TGFbeta1_2day_batch2, subset = nFeature_RNA > 200 & nFeature_RNA < 8500 & percent.mt < 5)
MCF10A_TGFbeta1_3day_batch2 <- subset(MCF10A_TGFbeta1_3day_batch2, subset = nFeature_RNA > 200 & nFeature_RNA < 8500 & percent.mt < 5)
MCF10A_TGFbeta1_4day_batch1 <- subset(MCF10A_TGFbeta1_4day_batch1, subset = nFeature_RNA > 200 & nFeature_RNA < 8500 & percent.mt < 5)
MCF10A_TGFbeta1_8day_batch1 <- subset(MCF10A_TGFbeta1_8day_batch1, subset = nFeature_RNA > 200 & nFeature_RNA < 8500 & percent.mt < 5)
